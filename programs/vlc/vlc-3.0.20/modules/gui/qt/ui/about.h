...
"margin-bottom: 6px;"));
        ...
        footer->setStyleSheet(QString::fromUtf8("background-color: rgb(230, 230, 230);color:rgb(0,0,0);"));
    ...
    {
        aboutWidget->setWindowTitle(Q_("Dialog", nullptr));
        UpdateLabel->setText(Q_("Update", nullptr));
        checkUpdates->setText(Q_("Update", nullptr));
