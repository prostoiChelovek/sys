...
public:
    ...
    {
        FingerprintDialog->setWindowTitle(Q_("Audio Fingerprinting", nullptr));
        label_3->setText(Q_("Select a matching identity", nullptr));
        label_2->setText(Q_("No fingerprint has been found", nullptr));
        label->setText(Q_("Fingerprinting track...", nullptr));
    } // retranslateUi
