...
public:
    ...
    void setupUi(QWidget *SPrefsSubtitles)
    {
        ...
        QWidget::setTabOrder(OSDTitlePos, spuActiveBox);
        QWidget::setTabOrder(spuActiveBox, preferredLanguage);
        ...
        QWidget::setTabOrder(shadowCheck, backgroundCheck);
        QWidget::setTabOrder(backgroundCheck, subsPosition);
    ...
    {
        SPrefsSubtitles->setWindowTitle(Q_("Form", nullptr));
        groupBox_3->setTitle(Q_("On Screen Display", nullptr));
        OSDBox->setText(Q_("Enable On Screen Display (OSD)", nullptr));
        OSDTitleBox->setText(Q_("Show media title on video start", nullptr));
        OSDTitlePosLabel->setText(Q_("Position", nullptr));
        spuActiveBox->setText(Q_("Enable subtitles", nullptr));
        groupBox_2->setTitle(Q_("Subtitle Language", nullptr));
        subLangLabel->setText(Q_("Preferred subtitle language", nullptr));
        encodLabel->setText(Q_("Default encoding", nullptr));
        groupBox->setTitle(Q_("Subtitle effects", nullptr));
        fontLabel->setText(Q_("Font", nullptr));
        fontSizeLabel->setText(Q_("Font size", nullptr));
        fontColorLabel->setText(Q_("Font color", nullptr));
        fontEffectLabel->setText(Q_("Outline thickness", nullptr));
        outlineColorLabel->setText(Q_("Outline color", nullptr));
        shadowCheck->setText(Q_("Add a shadow", nullptr));
        subsPosLabel->setText(Q_("Force subtitle position", nullptr));
        subsPosition->setSuffix(Q_(" px", nullptr));
        backgroundCheck->setText(Q_("Add a background", nullptr));
    } // retranslateUi
