...
public:
    ...
    {
        OpenDisk->setWindowTitle(Q_("Form", nullptr));
        diskGroupBox->setTitle(Q_("Disc Selection", nullptr));
        dvdRadioButton->setText(Q_("DVD", nullptr));
        bdRadioButton->setText(Q_("Blu-ray", nullptr));
        audioCDRadioButton->setText(Q_("Audio CD", nullptr));
        vcdRadioButton->setText(Q_("SVCD/VCD", nullptr));
#if QT_CONFIG(tooltip)
        dvdsimple->setToolTip(Q_("Disable Disc Menus", nullptr));
#endif // QT_CONFIG(tooltip)
        dvdsimple->setText(Q_("No disc menus", nullptr));
        deviceLabel->setText(Q_("Disc device", nullptr));
        browseDiscButton->setText(Q_("Browse...", nullptr));
        diskOptionBox->setTitle(Q_("Starting Position", nullptr));
        titleLabel->setText(Q_("Title", nullptr));
        chapterLabel->setText(Q_("Chapter", nullptr));
        diskOptionBox_2->setTitle(Q_("Audio and Subtitles", nullptr));
        audioLabel->setText(Q_("Audio track", nullptr));
        subtitlesLabel->setText(Q_("Subtitle track", nullptr));
