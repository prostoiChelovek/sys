...
public:
    ...
    {
        Vlm->setWindowTitle(Q_("VLM configurator", nullptr));
        mediaConfBox->setTitle(Q_("Media Manager Edition", nullptr));
        nameLabel->setText(Q_("Name:", nullptr));
        enableCheck->setText(Q_("Enable", nullptr));
        inputLabel->setText(Q_("Input:", nullptr));
        inputButton->setText(Q_("Select Input", nullptr));
        outputLabel->setText(Q_("Output:", nullptr));
        outputButton->setText(Q_("Select Output", nullptr));
        schedBox->setTitle(Q_("Time Control", nullptr));
        vodBox->setTitle(Q_("Mux Control", nullptr));
        label->setText(Q_("Muxer:", nullptr));
        muxLedit->setInputMask(Q_("AAAA; ", nullptr));
        loopBCast->setText(Q_("Loop", nullptr));
        addButton->setText(Q_("Add", nullptr));
        clearButton->setText(Q_("Clear", nullptr));
        saveButton->setText(Q_("Save", nullptr));
        mediaBox->setTitle(Q_("Media Manager List", nullptr));
    } // retranslateUi
