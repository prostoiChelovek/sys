...
public:
    ...
    {
        updateWidget->setWindowTitle(Q_("VLC media player updates", nullptr));
        updateDialogLabel->setText(Q_("Check for VLC updates", nullptr));
        label->setText(Q_("Launching an update request...", nullptr));
        label_2->setText(Q_("Do you want to download it?", nullptr));
    } // retranslateUi
