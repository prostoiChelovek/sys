...
public:
    ...
    void setupUi(QWidget *Profiles)
    {
        ...
        FLACMux->setObjectName(QString::fromUtf8("FLACMux"));
        ...
        MP3Mux->setObjectName(QString::fromUtf8("MP3Mux"));
    ...
    {
        Profiles->setWindowTitle(Q_("Profile edition", nullptr));
        FLACMux->setText(Q_("FLAC", nullptr));
        MOVMux->setText(Q_("MP&4/MOV", nullptr));
        OggMux->setText(Q_("Ogg/Ogm", nullptr));
        MKVMux->setText(Q_("M&KV", nullptr));
        MJPEGMux->setText(Q_("M&JPEG", nullptr));
        PSMux->setText(Q_("MPEG-PS", nullptr));
        FLVMux->setText(Q_("F&LV", nullptr));
        TSMux->setText(Q_("&MPEG-TS", nullptr));
        RAWMux->setText(Q_("RAW", nullptr));
        WAVMux->setText(Q_("WAV", nullptr));
        WEBMux->setText(Q_("Webm", nullptr));
        MPEG1Mux->setText(Q_("MPEG &1", nullptr));
        AVIMux->setText(Q_("AVI", nullptr));
        ASFMux->setText(Q_("ASF/WMV", nullptr));
        MP3Mux->setText(Q_("MP&3", nullptr));
        muxcaps->setTitle(Q_("Features", nullptr));
        capsubs->setText(Q_("Subtitles", nullptr));
        capstream->setText(Q_("Streamable", nullptr));
        capchaps->setText(Q_("Chapters", nullptr));
        capaudio->setText(Q_("Audio", nullptr));
        capvideo->setText(Q_("Video", nullptr));
        capmenu->setText(Q_("Menus", nullptr));
        muxerwarning->setText(QString());
        tabWidget->setTabText(tabWidget->indexOf(muxertab), Q_("Encapsulation", nullptr));
        valueholder_video_enable->setTitle(Q_("Video", nullptr));
        valueholder_video_copy->setText(Q_("Keep original video track", nullptr));
        vCodecLabel->setText(Q_("Codec", nullptr));
        vBitrateLabel->setText(Q_("Bitrate", nullptr));
        vFrameLabel->setText(Q_("Fra&me Rate", nullptr));
        valueholder_vcodec_framerate->setSpecialValueText(Q_("Same as source", nullptr));
        valueholder_vcodec_framerate->setPrefix(QString());
        valueholder_vcodec_framerate->setSuffix(Q_(" fps", nullptr));
        label_4->setText(Q_("Custom options", nullptr));
        label_3->setText(Q_("&Quality", nullptr));
        valueholder_vcodec_qp->setSpecialValueText(Q_("Not Used", nullptr));
        valueholder_vcodec_bitrate->setSpecialValueText(Q_("Not Used", nullptr));
        valueholder_vcodec_bitrate->setSuffix(Q_(" kb/s", nullptr));
        transcodevideo->setTabText(transcodevideo->indexOf(tab_1), Q_("Encoding parameters", nullptr));
        label->setText(Q_("You just need to fill one of the three following parameters, VLC will autodetect the other using the original aspect ratio", nullptr));
        vScaleLabel->setText(Q_("Scale", nullptr));
        Framesize->setText(Q_("Frame size", nullptr));
        widthLabel->setText(Q_("Width", nullptr));
        valueholder_vcodec_width->setSpecialValueText(Q_("Auto", nullptr));
        valueholder_vcodec_width->setSuffix(Q_("px", nullptr));
        heightLabel->setText(Q_("Height", nullptr));
        valueholder_vcodec_height->setSpecialValueText(Q_("Auto", nullptr));
        valueholder_vcodec_height->setSuffix(Q_("px", nullptr));
        transcodevideo->setTabText(transcodevideo->indexOf(tab), Q_("Resolution", nullptr));
        transcodevideo->setTabText(transcodevideo->indexOf(tab_2), Q_("Filters", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(videoCodec), Q_("Video codec", nullptr));
        valueholder_audio_enable->setTitle(Q_("Audio", nullptr));
        valueholder_audio_copy->setText(Q_("Keep original audio track", nullptr));
        aCodecLabel->setText(Q_("Codec", nullptr));
        aBitrateLabel->setText(Q_("Bitrate", nullptr));
        aChannelsLabel->setText(Q_("Channels", nullptr));
        valueholder_acodec_bitrate->setSuffix(Q_(" kb/s", nullptr));
        aSampleLabel->setText(Q_("Sa&mple Rate", nullptr));
        transcodeaudio->setTabText(transcodeaudio->indexOf(tab_3), Q_("Encoding parameters", nullptr));
        transcodeaudio->setTabText(transcodeaudio->indexOf(tab_4), Q_("Filters", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(audioCodec), Q_("Audio codec", nullptr));
        valueholder_subtitles_enable->setTitle(Q_("Subtitles", nullptr));
        label_2->setText(Q_("Codec", nullptr));
        valueholder_subtitles_overlay->setText(Q_("Overlay subtitles on the video", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(subtitles), Q_("Subtitles", nullptr));
        label_5->setText(Q_("Profile &Name", nullptr));
    } // retranslateUi
